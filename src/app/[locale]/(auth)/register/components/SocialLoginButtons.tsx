  ...
  return (
    <div className="flex justify-center space-x-6">
      <button
        ...
        className="w-1/2 rounded-lg h-12 bg-gray-50  border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition"
      >
        <svg
      ...
      <button
        type="button"
        aria-label={t("facebookSignUp")}
        title={t("facebookSignUp")}
        className=" h-12 bg-gray-50 w-1/2 rounded-lg border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
        ...
        >
          ...
          <path
            d="M16.6711 15.4688L17.2031 12H13.875V9.75C13.875 8.8008 14.3391 7.875 15.8297 7.875H17.3438V4.9219C17.3438 4.9219 15.9703 4.6875 14.6578 4.6875C11.9156 4.6875 10.125 6.3469 10.125 9.35625V12H7.07812V15.4688H10.125V23.8547C10.7367 23.9508 11.3625 24 12 24C12.6375 24 13.2633 23.9508 13.875 23.8547V15.4688H16.6711Z"
            fill="white"
          />
        </svg>
      </button>
