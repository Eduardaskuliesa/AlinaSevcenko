...
const MobileCartDrawer = ({ courseData }: MobileCartDrawerProps) => {
  ...
  return (
    <>
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t-2 border-primary-light shadow-lg z-40 lg:hidden">
      ...
      <Sheet open={isOpen} onOpenChange={setIsOpen}>
        <SheetContent
          side="bottom"
          className="h-[85vh] sm:h-[80vh] lg:hidden p-0 bg-white"
        >
          ...
          <div className="px-4 sm:px-6 pb-6 overflow-y-auto h-[calc(85vh-70px)] sm:h-[calc(80vh-80px)]">
            {/* Plan Options */}
